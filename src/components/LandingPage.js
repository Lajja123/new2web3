  ...
  <div className="main-landing-section">
    ...
    <div className="section1-inner-div">
        <div className="rightbar-main-div">
            ...
            <h1 className="rightbar-title">Take the first step in 
                your Web3 Journey!
            </h1>
        ...
        <div className="rightbar-main-content">
            <img src={landingImg} className="landing-image"/> </div>
    </div>

  </div>
  <section id="section2-landingpage">
    <h1 className="main-text-section2 font-face-alata">Our aim is frictionless user integration
into the web3 environment</h1>
  </section>
  ...
  <section className="section4-landing-page">
    <div className="box1">
        ...
        <img src={icon1} className="icon-img"/>
            ...
            <p className="content">Lack of user-
friendly interfaces
</p>
</div>
<div className="box2">
        ...
        <img src={icon2} className="icon-img"/>
            ...
            <p className="content">Developer centric/
Jargon heavy
</p>
</div>
<div className="box3">
        ...
        <img src={icon3} className="icon-img"/>
            ...
            <p className="content">Lack of trust & security 
</p>
  ...
  <p className="landing-section4-content">  We provide a <span className="text-color">step-by-step guide</span> to a completely new Web3 user.</p>
  <div className="section5-content-box">
    <div className="text-box1">Easy to follow 
steps
</div>
<div className="text-box2">Well-defined 
flow of 
learning
</div>
  </div>
